              ...
              <div className="max-w-6xl mx-auto text-center">
                ...
                <AdvancedScrollReveal delay={800} animation="spiral">
                  <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                    <Link href="/app">
                      <Button size="lg" className="relative group overflow-hidden bg-primary hover:bg-primary/90 text-primary-foreground shadow-glow px-8 py-4 text-lg hover-tilt cursor-pointer">
            ...
            <AdvancedScrollReveal delay={200} animation="spiral">
              <InteractiveCard variant="shimmer" intensity="strong" className="max-w-4xl mx-auto gradient-border bg-card">
                <div className="space-y-8">
                  ...
                  <div className="pt-4">
                    <Link href="/app">
                      <Button size="lg" className="relative group overflow-hidden bg-primary hover:bg-primary/90 text-primary-foreground shadow-glow px-10 py-5 text-xl hover-tilt cursor-pointer">
                        <span className="relative z-10 flex items-center">
                          Launch App
